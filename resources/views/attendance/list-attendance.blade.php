                    ...
                    <div class="card card-outline card-olive">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                <a href="{{ secure_url('attendance/pdf', ['trainingId' => $training->id]) }}" class="btn bg-gradient-danger">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($attendances as $attendance)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ secure_url('attendance/generate-certificate', ['training_id' => $training->id, 'attendance_id' => $attendance->id]) }}" class="btn btn-primary">
