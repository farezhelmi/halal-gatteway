		...
		<div class="container-login100" style="background-image: url({{ asset('Login_v3/images/bg-02.png') }});">
			<div class="wrap-login100">
				<form action="{{ route('register-store') }}" method="post" class="login100-form validate-form">
					...
					<br>
					<center><h4 style="color:white"><b>{{ $settings->title }}</b></h4></center>
					<br><br>
                    ...
                    <div style="color: white;">
                        <span style="font-size:20px;">Create New Account</span>
                    </div>
                    <br>
                    ...
                    <div class="form-group row ">
                        <label class="control-label col-md-12" style="color: white;">Role <font color="red">*</font></label>
                        <div class="col-md-12">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-12">
                            <input type="number" id="phone_mobile" name="phone_mobile" class="form-control">
                        </div>
                    </div>
                    
                    <br>
					<div class="container-login100-form-btn">
						<button type="submit" class="login100-form-btn btn-block">Sign Up</button>
					</div>
					<br>
